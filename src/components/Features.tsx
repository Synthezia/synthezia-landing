...
const features = [
  ...
  },
  {
    icon: Bot,
    title: 'AI Summaries',
    description: 'Meeting, Lecture, Interview, General, Custom modes via Ollama.',
  },
  {
    icon: Users,
...
function FeatureCard({ icon: Icon, title, description }: { icon: typeof Lock; title: string; description: string }) {
